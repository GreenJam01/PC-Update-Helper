...
def prediction():
    ...
    try:
        ...
        if chose_change == 'cpu':
            ...
            data[0]['cpu']['title'] = target_cpu.loc[chose_new_cpu, 'choose'].values[0]
            ...
            data[0]['gpu']['title'] = target_gpu.loc[chose_new_gpu, 'choose'].values[0]
            ...
            data[0]['hdd']['title'] = target_ssd.loc[chose_new_ssd, 'choose'].values[0]
