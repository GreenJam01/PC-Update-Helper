...
def loadAllDatasets():
  ...
  # Ryzen 5 dataset
  ################################################################################
  r5.loc[len(r5.index)] = ["AMD Ryzen 5 5500", 6, 4.2, 12, "am4", 3.0, 10590]
  r5.loc[len(r5.index)] = ["AMD Ryzen 5 5500GT", 6, 4.2, 12, "am4", 3.0, 10590]
  r5.loc[len(r5.index)] = ["AMD Ryzen 5 5600", 6, 4.4, 12, "am4", 4.0, 13590]
  r5.loc[len(r5.index)] = ["AMD Ryzen 5 5600G", 6, 4.4, 12, "am4", 3.0, 14690]
  r5.loc[len(r5.index)] = ["AMD Ryzen 5 5600X", 6, 4.6, 12, "am4", 4.0, 16990]
  r5.loc[len(r5.index)] = ["AMD Ryzen 5 5600GT", 6, 4.6, 12, "am4", 3.0, 17990]
  ################################################################################
  # Intel core 5 dataset
  ################################################################################
  i5.loc[len(i5.index)] = ["Intel Core i5 12400", 6, 4.4, 12, "LGA1700", 5.0, 17990]
  i5.loc[len(i5.index)] = ["Intel Core i5 12400F", 6, 4.4, 12, "LGA1700", 5.0, 15990]
  i5.loc[len(i5.index)] = ["Intel Core i5 12400T", 6, 4.2, 12, "LGA1700", 5.0, 22990]
  ################################################################################
  # matherboads dataset
  ################################################################################
  # mb_am4 = pd.read_excel(r'./datasets/mb_am4.xlsx')
