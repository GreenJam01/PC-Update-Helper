    ...
    <header className={'header'}>
      ...
      <nav className={'navigation'}>
        <ul className={'navigation_list'}>
          ...
          <li><Link to={AppRoutes.AssemblePage} className={'navigation_button'}>Улучшить ПК</Link></li>
          ...
          <li><Link to={AppRoutes.InfoPage} className={'navigation_button'}>Сканировать ПК</Link></li>
        </ul>
      </nav>
    </header>
  );
